...
var myBarChart = new Chart($('#myBarChart'), {
    ...
    data: {
        ...
        datasets: [{
            label: 'OI%',
            data: [ 
                {{ $question_oi[0]['answer'] }},
                {{ $question_oi[1]['answer'] }},
                {{ $question_oi[2]['answer'] }},
                {{ $question_oi[3]['answer'] }},
                {{ $question_oi[4]['answer'] }},
                {{ $question_oi[5]['answer'] }},
                {{ $question_oi[6]['answer'] }},
                {{ $question_oi[7]['answer'] }},
                {{ $question_oi[8]['answer'] }},
                {{ $question_oi[9]['answer'] }},
                {{ $question_oi[10]['answer'] }},
                {{ $question_oi[11]['answer'] }},
                {{ $question_oi[12]['answer'] }},
                {{ $question_oi[13]['answer'] }},
                {{ $question_oi[14]['answer'] }},
                {{ $question_oi[15]['answer'] }},
                {{ $question_oi[16]['answer'] }},
                {{ $question_oi[17]['answer'] }}
            ],
